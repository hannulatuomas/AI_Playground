#!/usr/bin/env python3
"""
Comprehensive Linux Commands Database with Distro-specific tags
50+ most used commands for Debian, Ubuntu, Kali Linux, and Arch Linux
"""
...
# Comprehensive Linux commands with distro-specific tags
COMPREHENSIVE_COMMANDS = [
    # Essential File Management Commands
    {
        ...
        "tags": ["basic", "files", "directory", "listing", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "cp",
        ...
        "category": "File Management",
        "tags": ["basic", "files", "copy", "backup", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "mv",
        ...
        "category": "File Management",
        "tags": ["basic", "files", "move", "rename", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "rm",
        ...
        "category": "File Management",
        "tags": ["basic", "files", "delete", "remove", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "find",
        ...
        "category": "File Management",
        "tags": ["advanced", "files", "search", "locate", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "ln",
        ...
        "category": "File Management",
        "tags": ["basic", "files", "links", "symlink", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "rsync",
        ...
        "category": "File Management",
        "tags": ["advanced", "sync", "backup", "network", "files", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "tar",
        ...
        "category": "File Management",
        "tags": ["basic", "compression", "archive", "backup", "debian", "ubuntu", "kali", "arch"]
    },
    ...
    # Text Processing Commands
    {
        ...
        "tags": ["basic", "text", "search", "regex", "logs", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "sed",
        ...
        "category": "Text Processing",
        "tags": ["advanced", "text", "replace", "edit", "regex", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "awk",
        ...
        "category": "Text Processing",
        "tags": ["advanced", "text", "processing", "columns", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "sort",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "sorting", "processing", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "uniq",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "duplicates", "processing", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "wc",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "counting", "statistics", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "cut",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "columns", "extract", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "tr",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "translate", "transform", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "tail",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "logs", "monitoring", "files", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "head",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "files", "display", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "less",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "pager", "navigation", "files", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "more",
        ...
        "category": "Text Processing",
        "tags": ["basic", "text", "pager", "files", "debian", "ubuntu", "kali", "arch"]
    },
    ...
    # System Monitoring Commands
    {
        ...
        "tags": ["basic", "system", "processes", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "top",
        ...
        "category": "System Monitoring",
        "tags": ["basic", "system", "monitoring", "processes", "cpu", "memory", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "htop",
        ...
        "category": "System Monitoring",
        "tags": ["advanced", "system", "monitoring", "processes", "interactive", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "df",
        ...
        "category": "System Monitoring",
        "tags": ["basic", "system", "disk", "space", "filesystem", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "free",
        ...
        "category": "System Monitoring",
        "tags": ["basic", "memory", "system", "monitoring", "ram", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "uptime",
        ...
        "category": "System Monitoring",
        "tags": ["basic", "system", "uptime", "load", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "iostat",
        ...
        "category": "System Monitoring",
        "tags": ["advanced", "system", "io", "performance", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "vmstat",
        ...
        "category": "System Monitoring",
        "tags": ["advanced", "system", "memory", "performance", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "which",
        ...
        "category": "System Monitoring",
        "tags": ["basic", "system", "path", "executables", "location", "debian", "ubuntu", "kali", "arch"]
    },
    ...
    # Networking Commands
    {
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "connectivity", "icmp", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "wget",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "download", "http", "ftp", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "curl",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "http", "api", "download", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "ssh",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "security", "remote", "ssh", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "scp",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "security", "copy", "ssh", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "netstat",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "connections", "ports", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "ss",
        ...
        "category": "Networking",
        "tags": ["advanced", "networking", "sockets", "monitoring", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "nslookup",
        ...
        "category": "Networking",
        "tags": ["basic", "networking", "dns", "lookup", "debian", "ubuntu", "kali", "arch"]
    },

    # Security Commands (especially important for Kali Linux)
    {
        "name": "chmod",
        ...
        "category": "Security",
        "tags": ["basic", "security", "permissions", "files", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "chown",
        ...
        "category": "Security",
        "tags": ["basic", "security", "ownership", "files", "permissions", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "iptables",
        ...
        "category": "Security",
        "tags": ["advanced", "security", "firewall", "network", "admin", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "ufw",
    ...
    },
    {
        ...
        "category": "Security",
        "tags": ["advanced", "security", "scanning", "network", "kali", "debian", "ubuntu", "arch"]
    },
    ...
    # User Management Commands
    {
        ...
        "tags": ["basic", "security", "permissions", "admin", "user", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "su",
        ...
        "category": "User Management",
        "tags": ["basic", "user", "switch", "security", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "useradd",
        ...
        "category": "User Management",
        "tags": ["advanced", "user", "admin", "account", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "usermod",
        ...
        "category": "User Management",
        "tags": ["advanced", "user", "modify", "groups", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "passwd",
        ...
        "category": "User Management",
        "tags": ["basic", "user", "password", "security", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "whoami",
        ...
        "category": "User Management",
        "tags": ["basic", "user", "identity", "current", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "id",
        ...
        "category": "User Management",
        "tags": ["basic", "user", "groups", "permissions", "identity", "debian", "ubuntu", "kali", "arch"]
    },

    # Package Management Commands (Distro-specific)
    {
        "name": "apt",
    ...
    # Process Control Commands
    {
        ...
        "tags": ["basic", "system", "service", "systemd", "control", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "service",
    ...
    },
    {
        ...
        "category": "Process Control",
        "tags": ["basic", "processes", "signals", "terminate", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "killall",
        ...
        "category": "Process Control",
        "tags": ["basic", "processes", "kill", "name", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "nohup",
        ...
        "examples": [
            ...
            "nohup wget large-file.zip &",
            "nohup ./backup.sh > backup.log &"
        ],
        "category": "Process Control",
        "tags": ["advanced", "processes", "background", "persistent", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "crontab",
        ...
        "category": "Process Control",
        "tags": ["basic", "scheduling", "automation", "cron", "service", "debian", "ubuntu", "kali", "arch"]
    },
    ...
    # Disk Management Commands
    {
        ...
        "tags": ["advanced", "disk", "partitions", "admin", "storage", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "lsblk",
        ...
        "category": "Disk Management",
        "tags": ["basic", "disk", "block devices", "storage", "info", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "mount",
        ...
        "category": "Disk Management",
        "tags": ["basic", "disk", "filesystem", "storage", "mount", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "umount",
        ...
        "category": "Disk Management",
        "tags": ["basic", "disk", "filesystem", "unmount", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "du",
        ...
        "category": "Disk Management",
        "tags": ["basic", "disk", "space", "usage", "directory", "debian", "ubuntu", "kali", "arch"]
    },
    {
        "name": "parted",
        ...
        "category": "Disk Management",
        "tags": ["advanced", "disk", "partitions", "gpt", "admin", "debian", "ubuntu", "kali", "arch"]
    }
]

async def populate_comprehensive_database():
    """Populate the database with comprehensive Linux commands"""
    ...
    # Insert commands
    commands_to_insert = []
    for cmd_data in COMPREHENSIVE_COMMANDS:
        command = {
            "id": str(uuid.uuid4()),
            "name": cmd_data["name"],
    ...
    distro_counts = {"debian": 0, "ubuntu": 0, "kali": 0, "arch": 0}
    ...
    # Close connection
    client.close()
    print(f"\n🎉 Comprehensive Linux database with {len(commands_to_insert)} commands completed!")

if __name__ == "__main__":
    asyncio.run(populate_comprehensive_database())