"""
Bash Documentation Agent

This agent specializes in maintaining documentation for Bash projects.
"""
...
class ShellDocumentationAgent(DocumentationAgentBase):
    """
    Documentation agent specialized for Bash projects.
    
    Features:
    - Bash-specific docstring/comment formats
    - Project structure awareness
    - comment blocks documentation generation
    - Best practices for Bash documentation
    """
    
    def __init__(
        self,
        name: str = "documentation_bash",
        description: str = "Bash-specific documentation agent",
        **kwargs
    ):
        """
        Initialize Bash documentation agent.
        ...
        self.logger.info("ShellDocumentationAgent initialized")
    ...
    def _generate_code_documentation(
        ...
        """
        Generate Bash-specific code documentation.
        ...
        prompt = f"""Add comprehensive comment blocks documentation to this Bash code.
...
Instructions:
1. Use comment blocks format for documentation
2. Follow Bash documentation conventions from documentation_preferences.md
3. Document all functions, variables, and script sections
...
"""
    ...
    def _get_documentation_format(self) -> Dict[str, Any]:
        """
        Get Bash-specific documentation format specifications.
    ...
    def _validate_documentation(self, doc_content: str) -> Dict[str, Any]:
        """
        Validate Bash-specific documentation.
        ...
        if '#' in doc_content:
            warnings.append('Uses comment blocks (good for Bash)')
...
# Export
__all__ = ['ShellDocumentationAgent']
