# Web (JavaScript/TypeScript) Code Analysis Preferences

## Overview

This document defines code analysis preferences and standards for Web (JavaScript/TypeScript) projects.
...
- Use npm for security analysis
- Use yarn for security analysis
- Use webpack for security analysis
