# PowerShell Code Analysis Preferences

## Overview

This document defines code analysis preferences and standards for PowerShell projects.
...
- Use PSScriptAnalyzer for security analysis
