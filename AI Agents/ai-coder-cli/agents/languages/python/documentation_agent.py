...
This agent specializes in maintaining documentation for Python projects.
"""
...
class PythonDocumentationAgent(DocumentationAgentBase):
    """
    Documentation agent specialized for Python projects.
    
    Features:
    - Python-specific docstring/comment formats
    - Project structure awareness
    - Google-style docstrings documentation generation
    - Best practices for Python documentation
    """
    
    def __init__(
        self,
        name: str = "documentation_python",
        description: str = "Python-specific documentation agent",
        **kwargs
    ):
        """
        Initialize Python documentation agent.
        ...
        self.logger.info("PythonDocumentationAgent initialized")
    ...
    def _generate_code_documentation(
        ...
        """
        Generate Python-specific code documentation.
        ...
        prompt = f"""Add comprehensive Google-style docstrings documentation to this Python code.
...
Instructions:
1. Use Google-style docstrings format for documentation
2. Follow Python documentation conventions from documentation_preferences.md
3. Document all functions, classes, methods, and modules
...
"""
    ...
    def _get_documentation_format(self) -> Dict[str, Any]:
        """
        Get Python-specific documentation format specifications.
        ...
        return {
            ...
            'code_doc_style': 'Google-style docstrings',
    ...
    def _validate_documentation(self, doc_content: str) -> Dict[str, Any]:
        """
        Validate Python-specific documentation.
        ...
        if '"""' in doc_content:
            warnings.append('Uses docstrings (good for Python)')
        
        # Check for type hints mention
        if 'Args:' in doc_content or 'Returns:' in doc_content:
            warnings.append('Follows Google-style docstring format')
...
# Export
__all__ = ['PythonDocumentationAgent']
