# Python Testing Preferences

## Overview

This document defines testing preferences and guidelines for Python projects.

## Testing Frameworks

### Recommended Frameworks

- **pytest**: Preferred for Python testing
- **unittest**: Preferred for Python testing
...
- Use descriptive names: `test_<feature>.ext`
